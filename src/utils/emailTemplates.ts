...
<head>
  ...
  <style>
    ...
    body { margin: 0; padding: 0; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: #f8f9fa; }
    .container { max-width: 650px; margin: 40px auto; background: #fff; box-shadow: 0 4px 24px rgba(0,0,0,0.06); border-radius: 16px; overflow: hidden; }
    .header { padding: 40px 50px; background: linear-gradient(135deg, #0a4d3c 0%, #0d6b4f 50%, #0a4d3c 100%); position: relative; text-align: center; }
    ...
    .logo-wrapper { display: inline-flex; align-items: center; justify-content: center; gap: 20px; }
    .logo { max-width: 80px; height: auto; filter: drop-shadow(0 2px 8px rgba(0,0,0,0.15)); display: block; }
    .brand-text { color: #ffffff; font-size: 28px; font-weight: 800; letter-spacing: -0.5px; text-shadow: 0 2px 4px rgba(0,0,0,0.2); display: block; }
    .venture-badge { margin-top: 16px; display: inline-block; background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); padding: 8px 20px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.2); }
    .venture-text { color: #fff; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.2px; }
    .hero { padding: 60px 50px; text-align: center; background: linear-gradient(180deg, #fff 0%, #f8fafb 100%); position: relative; }
    .hero::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(90deg, transparent 0%, #10b981 50%, transparent 100%); }
    .hero-title { font-size: 36px; font-weight: 700; color: #1a202c; margin: 0 0 16px 0; line-height: 1.2; letter-spacing: -0.5px; }
    .hero-subtitle { font-size: 18px; font-weight: 400; color: #64748b; margin: 0; line-height: 1.6; }
    .content { padding: 50px; background: #fff; }
    .message { font-size: 16px; line-height: 1.8; color: #475569; margin: 0 0 28px 0; }
    .card { background: linear-gradient(135deg, #f8fafb 0%, #fff 100%); border: 1px solid #e2e8f0; border-radius: 16px; padding: 32px; margin: 32px 0; box-shadow: 0 2px 8px rgba(0,0,0,0.04); }
    .card-title { font-size: 13px; font-weight: 700; color: #0a4d3c; text-transform: uppercase; letter-spacing: 1.2px; margin: 0 0 24px 0; padding-bottom: 12px; border-bottom: 2px solid #10b981; }
    .info-row { padding: 16px 0; border-bottom: 1px solid #f1f5f9; display: flex; align-items: flex-start; gap: 16px; }
    .info-row:last-child { border-bottom: none; }
    .info-icon { width: 24px; height: 24px; background: linear-gradient(135deg, #0a4d3c 0%, #10b981 100%); border-radius: 6px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 2px; }
    .info-icon::after { content: '✓'; color: #fff; font-size: 14px; font-weight: 700; }
    .info-content { flex: 1; }
    .info-label { font-size: 13px; font-weight: 600; color: #64748b; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.5px; }
    .info-value { font-size: 15px; color: #1e293b; font-weight: 500; line-height: 1.6; }
    .divider { height: 1px; background: linear-gradient(90deg, transparent 0%, #e2e8f0 50%, transparent 100%); margin: 40px 0; }
    .cta { text-align: center; padding: 40px 0; }
    .cta-button { display: inline-block; padding: 18px 40px; background: linear-gradient(135deg, #0a4d3c 0%, #10b981 100%); color: #fff !important; text-decoration: none; border-radius: 12px; font-weight: 600; font-size: 16px; letter-spacing: 0.3px; box-shadow: 0 4px 16px rgba(10,77,60,0.25); }
    .footer { padding: 50px; background: linear-gradient(135deg, #1a202c 0%, #2d3748 100%); color: #cbd5e0; position: relative; }
    .footer::before { content: ''; position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: url('data:image/svg+xml,<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="dots" width="20" height="20" patternUnits="userSpaceOnUse"><circle cx="2" cy="2" r="1" fill="rgba(255,255,255,0.03)"/></pattern></defs><rect width="100" height="100" fill="url(%23dots)"/></svg>'); }
    .footer-content { position: relative; z-index: 1; text-align: center; }
    .footer-brand { font-size: 20px; font-weight: 800; color: #fff; margin: 0 0 8px 0; letter-spacing: -0.3px; }
    .footer-tagline { font-size: 14px; color: #a0aec0; margin: 0 0 32px 0; font-weight: 400; }
    .footer-divider { height: 1px; background: linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.1) 50%, transparent 100%); margin: 32px 0; }
    .social-links { margin: 32px 0; display: flex; justify-content: center; gap: 24px; flex-wrap: wrap; }
    .social-link { color: #10b981; text-decoration: none; font-size: 14px; font-weight: 600; padding: 8px 16px; border-radius: 8px; background: rgba(16,185,129,0.1); }
    .contact-info { font-size: 13px; color: #a0aec0; line-height: 1.8; margin: 24px 0 0 0; }
    .contact-info a { color: #10b981; text-decoration: none; }
    @media only screen and (max-width: 600px) {
      .container { margin: 20px; border-radius: 12px; }
      .header, .hero, .content, .footer { padding: 30px 24px; }
...
<body>
  <div class="container">
    <div class="header">
      ...
      ${venture ? `<div class="venture-badge"><div class="venture-text">${venture}</div></div>` : ''}
    </div>
    <div class="hero">
    ...
    <div class="footer">
      <div class="footer-content">
        ...
        <div class="social-links">
          <a href="https://linkedin.com/company/wealthyelephant" class="social-link">LinkedIn</a>
          <a href="https://instagram.com/wealthyelephant" class="social-link">Instagram</a>
          <a href="https://twitter.com/wealthyelephant" class="social-link">Twitter</a>
        </div>
        <div class="contact-info">
          ...
          Website: <a href="https://www.wealthyelephant.com">www.wealthyelephant.com</a><br><br>
          <span style="font-size: 12px; color: #718096;">© ${new Date().getFullYear()} Wealthy Elephant. All rights reserved.</span>
        </div>
      </div>
    </div>
  </div>
